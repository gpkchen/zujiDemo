...
@interface ZYBillConfirmItemCell ()
...
@implementation ZYBillConfirmItemCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if(self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]){
        ...
        [self.itemIV mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.mas_equalTo(ZYBillConfirmItemCellHeight - 30 * UI_H_SCALE);
        }];
...
- (void)showCellWithModel:(_m_GetPayBillInfo *)model{
    NSString *url = [model.imageUrl imageStyleUrl:CGSizeMake((ZYBillConfirmItemCellHeight - 30 * UI_H_SCALE) * 2, (ZYBillConfirmItemCellHeight - 30 * UI_H_SCALE) * 2)];

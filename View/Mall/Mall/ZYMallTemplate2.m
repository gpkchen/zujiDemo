...
static NSString *kCellIdentifier = @"ZYMallTemplate2CollectionCell";

@interface ZYMallTemplate2Cell()
...
@implementation ZYMallTemplate2Cell
...
@interface ZYMallTemplate2 ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation ZYMallTemplate2
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if(self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]){
        ...
        [self.collectionView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.height.mas_equalTo(187 * UI_H_SCALE);
        }];
    }
    return self;
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    if(scrollView.contentOffset.x > scrollView.contentSize.width - SCREEN_WIDTH){
        CGFloat centerY = (ZYMallTemplate2Height - 93.5 * UI_H_SCALE);
        ...
        CGPoint beginPoint = CGPointMake(SCREEN_WIDTH, (ZYMallTemplate2Height - 187 * UI_H_SCALE));
        CGPoint endPoint = CGPointMake(SCREEN_WIDTH, ZYMallTemplate2Height);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ZYMallTemplate2Cell *cell  = [collectionView dequeueReusableCellWithReuseIdentifier:kCellIdentifier forIndexPath:indexPath];
...
- (UICollectionView *)collectionView{
    if(!_collectionView){
        ...
        [_collectionView registerClass:[ZYMallTemplate2Cell class] forCellWithReuseIdentifier:kCellIdentifier];
